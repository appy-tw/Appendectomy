<?php
	...
	connect_valid();
	ECHO "<CENTER><FORM NAME=DATAINPUT ACTION=petition.php METHOD=POST>
	<TABLE BORDER=0 STYLE='FONT-SIZE:16'>
	<TR><TD STYLE='TEXT-ALIGN:CENTER;BACKGROUND-COLOR:#DDDDDD'>填寫連署表單</TD><TD STYLE='WIDTH:100;TEXT-ALIGN:CENTER;BORDER:2px solid #666666'><SPAN STYLE='CURSOR:POINTER;' ONCLICK=ADDFORM()>增加份數</SPAN></TD></TR>
	...
	<TR><TD COLSPAN=2 ALIGN=RIGHT><INPUT TYPE=BUTTON ONCLICK=checkInput() VALUE='製作連署書'></TD></TR>
	</TABLE>
	</FORM>";
