<?php
	...
	<TR><TD><INPUT TYPE=HIDDEN ID=Size NAME=Size VALUE=1>
		...
		<TR><TD STYLE='WIDTH:80;TEXT-ALIGN:CENTER'>電子信箱</TD><TD><INPUT TYPE=TEXT NAME=EMAIL STYLE='WIDTH:300;FONT-SIZE:16'></TD>
			...
			<TD ALIGN=CENTER>
				<SPAN STYLE='CURSOR:POINTER;COLOR:BLACK'><IMG SRC='info.png' STYLE='WIDTH:20' ALT='可製作數份罷免相同立委的連署書' TITLE='可製作數份罷免相同立委的連署書'></SPAN>
			</TD>
		</TR>
...
function ADDFORM()
{
	...
	document.getElementById('INPUTFORM').innerHTML+='<DIV><HR>'+
			...
			'<TR><TD STYLE=\'WIDTH:80;TEXT-ALIGN:CENTER\'>'+(no+1)+'</TD>'+
				...
				'<TD>身分證字號</TD><TD><INPUT TYPE=TEXT NAME=IDNo_'+no+' STYLE=\'WIDTH:150;FONT-SIZE:16\'></TD><TD><IMG SRC=\'info.png\' STYLE=\'WIDTH:20;CURSOR:POINTER\' ALT=\'請輸入半形英文數字\' TITLE=\'請輸入半形英文數字\'></TD></TR>'+
			'<TR><TD></TD>'+
