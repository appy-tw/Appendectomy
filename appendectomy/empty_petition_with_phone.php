...
IF($_POST['PetDescImgPath']!="")
{
	$QUERY_STRING="UPDATE DISTRICT_DATA SET PETDESCIMGPATH='".$_POST['PetDescImgPath']."' WHERE DISTRICT_ID='".$_POST['DISTRICT_ID']."'";
...
for($SEED=0;$SEED<$SIZE;$SEED++)
{
	...
	$DescImgPath=$_POST['PetDescImgPath'];
...
IF($DATA['petdescimgpath']==""&&$DescImgPath=="")
{
