<?php
	...
	ELSE IF($_GET[ACT]=="ADDEXE")
	{
		...
		$QUERY_STRING="INSERT INTO DOC_ACCEPT_SPOT 
			(NAME,CITY,DISTRICT,ADDRESS,TELEPHONE,NOTE,BUSINESS_HOUR,WEBSITE_PATH)
			VALUES(
			'".$_POST['SPOT_NAME']."',
			'".$_POST['CITY']."',
			'".$_POST['DISTRICT']."',
	...
	ELSE
	{
		...
		FOR($SEED=0;$SEED<$NO_OF_DATA;$SEED++)
		{
			...
			<INPUT TYPE=BUTTON ONCLICK=location.href='?ACT=DEL&ID=".$DATA[accept_spot_id]."' VALUE='刪除' STYLE='width:70'></TD></TR>
