...
class GenPDFTest extends CI_Controller {
...
//			$pdf->AddFont('WenQuanYiZenHei','','FPDF/WenQuanYiZenHei.php');
			$CHI_FONT = "droidsansfallback";
			$ENG_FONT = "droidsansfallback";
